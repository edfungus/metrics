...
/*
	...
	conceptually BetterRegistry with things moved around

*/

type EvenBetterRegistry struct {
	registry map[string]map[string][]*hashEntry
...
func (r *EvenBetterRegistry) Filter(k Key) []*hashEntry {
	return []*hashEntry{}
}
...
func (r *EvenBetterRegistry) getHashEntriesForKey(k Key) map[string][]*hashEntry {
	hashKeys := map[string][]*hashEntry{}
...
func findUnionOfHashEntries(m map[string][]*hashEntry) []*hashEntry {
